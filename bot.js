...
Rocket.on('message', message => {//help msg
  ...
  By : IIAHMED | __**شكرا لكم لاستعمال البوت**__
...
Rocket.on('message', message => {//invite
     ...
     let embed = new Discord.RichEmbed()
.setColor("RANDOM")
.setTitle("Click Here to invite Explosion System")
.setAuthor("Explosion System", "https://discordapp.com/channels/439182014231347210/471790072748834836")
.setTimestamp()
.setURL("https://discordapp.com/api/oauth2/authorize?client_id=484425572697767960&permissions=8&scope=bot")
...
const adminprefix = "p!";
const devs = ['365929628226945028' , '365929628226945028' , '365929628226945028'];
